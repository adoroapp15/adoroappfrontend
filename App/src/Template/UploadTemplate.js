            ...
            <View
              ...
              <ScrollView>
                ...
                <Text
                  ...
                  entity that registers, accesses, or uses the Platform.{'\n'}-
                  "Content" refers to any and all images, graphics, photos, or
                  other materials uploaded by the User to the Platform.{'\n'}
                  2. User's Ownership of Content {'\n'}
                  The User hereby declares, warrants, and represents that:{'\n'}
                  1. The User is the sole and exclusive owner of the
                  intellectual property rights in and to the Content, or the
                  User has obtained all necessary rights, licenses, consents,
                  and permissions to use, upload, and distribute the Content on
                  the Platform.{'\n'}
                  2. The Content does not infringe upon, misappropriate, or
                  violate any intellectual property rights or other proprietary
                  rights of any third party, including but not limited to
                  copyright, trademark, patent, trade secret, privacy rights, or
                  publicity rights.{'\n'}
                  3. The User retains all rights, title, and interest in and to
                  the Content, including but not limited to copyright and other
                  intellectual property rights.{'\n'}
                  3. License Grant to Platform {'\n'}
                  By uploading Content to the Platform, the User grants Adoro a
                  ...
                  connection with the operation of the Platform and Adoro's
                  business, including without limitation for promoting and
                  redistributing part or all of the Platform (and derivative
                  works thereof) in any media formats and through any media
                  channels.{'\n'}
                  4. Representations and Warranties {'\n'}
                  The User represents and warrants that:{'\n'}
                  1. The User has full authority to enter into this declaration
                  and to grant the rights granted herein.{'\n'}
                  2. The Content complies with all applicable laws, rules, and
                  regulations.{'\n'}
                  3. The Content is not subject to any third-party claims,
                  liens, or encumbrances.{'\n'}
                  5. Indemnification {'\n'}
                  The User agrees to indemnify, defend, and hold harmless Adoro,
                  ...
                  {'\n'}
                  1. The User's breach of any representation, warranty, or
                  obligation under this declaration. {'\n'}
                  2. The User's violation of any intellectual property rights or
                  other proprietary rights of any third party. {'\n'}
                  3. The User's use of the Platform in violation of any
                  applicable laws, rules, or regulations. {'\n'}
                  6. Governing Law {'\n'}
                  This declaration shall be governed by and construed in
                  accordance with the laws of Gurugram, without regard to its
                  conflict of law principles.{'\n'}
                  7. Entire Agreement {'\n'}
                  This declaration constitutes the entire agreement between the
                  User and Adoro regarding the subject matter hereof and
                  ...
                  8. Amendments {'\n'}
                  Adoro reserves the right to amend this declaration at any
                  time. The User will be notified of any such amendments, and
                  continued use of the Platform after such notification
                  constitutes acceptance of the amended terms.{'\n'}
                  IN WITNESS WHEREOF, the User has executed this Intellectual
                  Property Ownership Declaration as of the Effective Date.{'\n'}
                </Text>
                <View style={styles.checkboxContainer}>
                  <CheckBox
                    ...
                    tintColors={{
                      true: colors.color_TabBarColor,
                      false: colors.color_PlaceHolderColor,
                    }}
                  />
                  <Text style={{color: colors.color_TextNormal, fontSize: 16}}>
                    By signing this declaration, the User acknowledges that they
